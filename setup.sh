...
# casks
for pkg in spectacle bitwarden macupdater homebrew/cask-fonts/font-meslo-lg-nerd-font iterm2 notion whatsapp google-chrome fanny github visual-studio-code quicklook-json qlcolorcode qlstephen; do
