...
#
# brew package
for pkg in tldr autojump gpg pinentry-mac ykman htop zsh-autosuggestions tree pstree pidof openssh lnav ncdu mas chezmoi bitwarden-cli; do
...
# casks
for pkg in rectangle bitwarden macupdater homebrew/cask-fonts/font-meslo-lg-nerd-font iterm2 notion whatsapp google-chrome fanny github visual-studio-code deskreen syncthing; do
